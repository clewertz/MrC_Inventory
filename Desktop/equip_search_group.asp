...
<head>
<title>Nationstar Desktop Dashboard : Equipment Search Group</title>
...
<table class="eqTable">
	<tr><td colspan="4"><form id="DInSearchForm" name="DInSearchForm" method="post" action="SearchReturn.asp">
		<div style="float: left; margin-right: 18px; margin-bottom: 10px;">
			<select onChange = "UnhideOption()" name="DInSearchSelect" id="DInSearchSelect">
				...
				<input class="textareaC" name="txtSearch" rows="4" cols="60" id="txtSearch" placeholder="Search" maxlength="1500"/>	
