...
EquipSearch_cmd.ActiveConnection = MM_NationStar_STRING
	EquipSearch_cmd.CommandText = "SELECT DInType, DInModel, DInSerialNum, DInStatus, DInSite, DInImageVer, DInUserID, DInComputerName FROM dbo.DesktopInventory WHERE DInComputerName IN " + ComputerName + " ORDER BY DInStatus ASC, DInSite ASC, DInModel ASC"
