...
<%
'NUMBER OF ROWS TO DISPLAY ON MAIN PAGE************************************
Dim Repeat__numRows
Dim Repeat__index
        ...
        <div id="navigation">
			<ul id="menu-bar">
				...
				<li><a href="#">Administrative</a>
					...
					<li><a href="http://crdskweb01/desktop/equip_30days.asp">Last 30 Day</a></li>
					</ul>
				</li>
			</ul>
        </div>
...
%>
		...
		</form><form id="DInSearchForm" name="DInSearchForm" method="post" action="SearchReturn.asp">
		<div style="float: right; margin-right: 18px; margin-bottom: 10px;">
			<select onChange = "UnhideOption()" name="DInSearchSelect" id="DInSearchSelect">
				...
				<option value = "6">&nbsp;&nbsp;MAC Address</option>
			</select>
		  ...
		  <!--<td width="200" align="center"><label for="DInserial"></label><input name="DInserial" type="text" id="DInserial" maxlength="15" /><label for="DInserial"></label></td>-->
				<input class="txtBox" name="txtSearch" type="text" id="txtSearch" maxlength="35" placeholder="Search"/>
...
<table class="eqTable">
	<tr><td colspan="4"><h2>Equipment (latest <%=Repeat__numRows%>) that has checked in (past 5 days)</h2></td></tr>
